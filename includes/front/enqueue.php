...
function ju_enqueue(){
	wp_register_style('ju_google_fonts', 'http://fonts.googleapis.com/css?family=Lato:300,400,400italic,600,700|Raleway:300,400,500,600,700|Crete+Round:400italic" rel="stylesheet" type="text/css');
	...
	wp_register_style('ju_respnsive', get_template_directory_uri(). '/assets/css/responsive.css');
